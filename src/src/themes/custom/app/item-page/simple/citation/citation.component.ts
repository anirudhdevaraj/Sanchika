...
export class CitationComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  get activeText(): string {
    ...
    switch (this.activeTab) {
      case 'mla':     return this.citationService.formatMLA(this.citationData, this.includeDescription);
      case 'chicago': return this.citationService.formatChicago(this.citationData, this.includeDescription);
      case 'bibtex':  return this.citationService.formatBibTeX(this.citationData, this.includeDescription);
      case 'ris':     return this.citationService.formatRIS(this.citationData, this.includeDescription);
      case 'apa':
      default:        return this.citationService.formatAPA(this.citationData, this.includeDescription);
    }
  }
