...
@listableObjectComponent('PublicationSearchResult', ViewMode.GridElement, Context.Any, 'custom')
@listableObjectComponent(ItemSearchResult, ViewMode.GridElement, Context.Any, 'custom')
@Component({
...
export class ItemSearchResultGridElementComponent extends BaseComponent implements OnInit {
  ...
  override ngOnInit(): void {
    ...
    // Fallback logic for thumbnail icons
